  ...
  return (
    ...
    <form className="feedForm " onSubmit={handleSubmit}>
        ...
        <div className="boxText">
          ...
          <input className="postFormInput" type="text" onChange={handleMessageChange} data-testid="post-input" placeholder="Say Hello!" required/>
        </div>
        ...
        <div className="imageIcon">
          ...
          <div className="iconSingle">
          <label>
          <img className="photoIcon" src="src/assets/image.png"/>
